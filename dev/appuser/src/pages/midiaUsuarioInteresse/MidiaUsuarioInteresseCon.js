...
import MidiaUsuarioList from "./MidiaUsuarioInteresseList";
import MidiaUsuarioForm from "./MidiaUsuarioInteresseForm";
import MidiaUsuarioSrv from "./MidiaUsuarioInteresseSrv";
    ...
    MidiaUsuarioSrv.listarStatus(JSON.parse(sessionStorage.getItem("userId")))
      .then((response) => {
        ...
        toastRef.current.show({
          severity: "success",
          summary: "Minhas mídias interessantes atualizadas!",
          life: 3000,
        });
      })
      .catch((e) => {
