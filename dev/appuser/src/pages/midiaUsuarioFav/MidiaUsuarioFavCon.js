...
import MidiaUsuarioList from "./MidiaUsuarioFavList";
import MidiaUsuarioForm from "./MidiaUsuarioFavForm";
import MidiaUsuarioSrv from "./MidiaUsuarioFavSrv";
...
function MidiaUsuarioCon() {
  ...
  const onClickAtualizar = () => {
    MidiaUsuarioSrv.listarFavoritos(JSON.parse(sessionStorage.getItem("userId")))
      .then((response) => {
