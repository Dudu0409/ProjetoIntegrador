...
import MidiaUsuarioList from "./MidiaUsuarioAssistindoList";
import MidiaUsuarioForm from "./MidiaUsuarioAssistindoForm";
import MidiaUsuarioSrv from "./MidiaUsuarioAssistindoSrv";
    ...
    MidiaUsuarioSrv.listarStatus(JSON.parse(localStorage.getItem("userId")))
      .then((response) => {
        ...
        toastRef.current.show({
          severity: "success",
          summary: "Minhas mídias que estou assistindo atualizadas!",
          life: 3000,
        });
      })
      .catch((e) => {
